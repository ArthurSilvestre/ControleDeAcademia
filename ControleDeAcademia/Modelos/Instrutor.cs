...
namespace ControleDeAcademia{
    class Instrutor{
        ...
        private int ativo;
        private int codgrauinst;

        //Construtores
        public Instrutor() { }
        public Instrutor(int deleted, DateTime dtcadastro, DateTime dtalteracao, int codigo, string nome, int cpf, int rg, byte[] foto, DateTime dtnascimento, int cep, string estado, string cidade, string bairro, string endereco, int numero, string complemento, int dddtelefone, int telefone, int dddcelular1, int celular1, int dddcelular2, int celular2, int senha, byte[] digitaldireita1, byte[] digitaldireita2, byte[] digitaldireita3, byte[] digitaldireita4, byte[] digitaldireita5, byte[] digitalesquerda1, byte[] digitalesquerda2, byte[] digitalesquerda3, byte[] digitalesquerda4, byte[] digitalesquerda5, int ativo, int codgrauinst){
