...
namespace EasyInnerSDK.Entity
{
    public class Inner
    {
        ...
        #region Flag Mensagem Temporizada
        ...
        private int _tentativasColeta;
        public int TentativasColeta
        {
            get { return _tentativasColeta; }
            set { _tentativasColeta = value; }
        } 
        ...
        #region InnerNetAcesso
        private bool innerNetAcesso;

        public bool InnerNetAcesso
        {
            get { return innerNetAcesso; }
            set { innerNetAcesso = value; }
        }
        #endregion
